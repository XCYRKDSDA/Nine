...
public static class AnimationEvaluator<ObjectT>
{
    ...
    public static void TweenAndSet(
        ref ObjectT obj,
        AnimationClip<ObjectT>? clip1,
        float t1,
        AnimationClip<ObjectT>? clip2,
        float t2,
    ...
    )
    {
        ...
        TrackEvaluator.TweenAndSet(
            ref obj,
            clip1 is null ? [] : clip1.Tracks,
            t1,
            clip2 is null ? [] : clip2.Tracks,
            t2,
            tweener,
            k
        );
