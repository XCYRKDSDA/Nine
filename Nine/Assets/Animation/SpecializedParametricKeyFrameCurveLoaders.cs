...
public class ParametricSingleCubicKeyFrameCurveLoader(
    JsonConverter<IParametric<float>>? valueConverter,
    JsonConverter<IParametric<float>>? gradientConverter = null
)
...
public class ParametricVector2CubicKeyFrameCurveLoader(
    JsonConverter<IParametric<Vector2>>? valueConverter,
    JsonConverter<IParametric<Vector2>>? gradientConverter = null
)
...
public class ParametricVector3CubicKeyFrameCurveLoader(
    JsonConverter<IParametric<Vector3>>? valueConverter,
    JsonConverter<IParametric<Vector3>>? gradientConverter = null
)
...
public class ParametricIntegerCubicKeyFrameCurveLoader(
    JsonConverter<IParametric<int>>? valueConverter,
    JsonConverter<IParametric<float>>? gradientConverter
)
...
public class ParametricSphereKeyFrameCurveLoader(
    JsonConverter<IParametric<Quaternion>>? valueConverter,
    JsonConverter<IParametric<Vector3>>? gradientConverter
)
